...
Andrej Karpathy 是一位在人工智能领域极具影响力的研究者和工程师。他最广为人知的身份是特斯拉 AI 总监，以及 [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki]] 模式的提出者。他在计算机视觉、深度学习和 AI 教育方面都做出了重要贡献。
...
**2024 年，Andrej Karpathy 提出了 [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki]] 模式，这是他最具影响力的创新之一。**
...
| 项目 | 说明 |
|------|------|
| [[LLM Wiki 生态/LLM Wiki 工具/NEXUS]] | 多代理记忆系统 |
| [[LLM Wiki 生态/LLM Wiki 工具/llmwiki]] | CLI 工具（1K+ stars |
| [[LLM Wiki 生态/LLM Wiki 工具/SeekLink]] | 行级检索工具 |
...
### LLM Wiki 生态
- [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki]] - LLM Wiki 详细介绍
- [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki 三层架构]] - 架构详解
...
- [[笔记与知识管理/笔记方法/Embrace Chaos]] - 拥抱一定程度的混乱

### 工具
- [[笔记与知识管理/笔记工具/Obsidian]] - 他推荐的笔记工具
- [[笔记与知识管理/笔记工具/Marp]] - 基于 Markdown 的演示文稿工具
- [[笔记与知识管理/笔记工具/Dataview]] - Obsidian 的动态查询插件
