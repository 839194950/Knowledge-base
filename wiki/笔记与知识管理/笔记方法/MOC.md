...
MOC 是 Map of Content（内容地图）的缩写！它是一个用来组织和导航相关笔记的索引页面！在 [[笔记与知识管理/笔记方法/原子笔记]] 满天飞的时候，MOC 就是你的导航图！
...
| 概念 | 关系 |
|------|------|
| **[[笔记与知识管理/笔记方法/原子笔记]]** | MOC 组织原子笔记 |
| **[[笔记与知识管理/笔记方法/Zettelkasten]]** | MOC 是 Zettelkasten 的一部分 |
| **文件夹** | MOC 比文件夹更灵活 |
| **标签** | 标签辅助，MOC 更结构化 |
