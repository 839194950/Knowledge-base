...
RAG 也有一些局限性！这也是 [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki]] 想要解决的！
...
让我们详细对比一下 RAG 和 [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki]]！
...
- 用小模型重新排序
- 提升相关度
- 类似 [[LLM Wiki 生态/LLM Wiki 工具/qmd]] 做的

### 3. 图 RAG（GraphRAG）

- 建立实体关系
- 知识图谱
- [[LLM Wiki 生态/LLM Wiki 工具/NEXUS]] 用了这个！

## 相关概念

- [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki]] - 另一种知识管理模式
- [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki 三层架构]] - LLM Wiki 的三层架构
- [[LLM Wiki 生态/LLM Wiki 工具/qmd]] - 搜索工具
- [[LLM Wiki 生态/LLM Wiki 工具/NEXUS]] - 用了 GraphRAG 的工具

## 总结

RAG 是一个强大且实用的技术！它简单易用，适合很多场景！但如果你想要知识复利和结构化管理，[[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki]] 可能是更好的选择！
