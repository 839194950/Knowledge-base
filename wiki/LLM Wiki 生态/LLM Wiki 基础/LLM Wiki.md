...
LLM Wiki 是 [[笔记与知识管理/重要人物/Andrej Karpathy]] 在 2024 年提出的一种个人知识管理方法。它的名字来源于两个词的组合：LLM（大语言模型）+ Wiki（维基百科式的知识组织方式）。
...
- [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki 三层架构]] - LLM Wiki 的架构设计
- [[LLM Wiki 生态/LLM Wiki 基础/LLM Wiki 操作流程]] - 具体的操作步骤
- [[笔记与知识管理/重要人物/Andrej Karpathy]] - 模式提出者
- [[AI 工具与技术/AI 技术/RAG]] - 检索增强生成
- [[笔记与知识管理/笔记工具/Obsidian]] - 常用的工具
