...
llmwiki 是一个基于 [[核心概念/LLM Wiki 基础/LLM Wiki]] 模式的 CLI（命令行）工具，由 ethanj 构建，GitHub 上已经有超过 1000 颗星！它是 LLM Wiki 模式的一个强大实现！
...
llmwiki 完美实现了 [[核心概念/LLM Wiki 基础/LLM Wiki]] 模式！

在 [[核心概念/LLM Wiki 基础/LLM Wiki 三层架构]] 中：
