...
NEXUS 是一个基于 [[核心概念/LLM Wiki 基础/LLM Wiki]] 模式的多代理记忆系统，由 lrdeoliveira 构建！它是 LLM Wiki 模式的一个完整和复杂的实现！
...
NEXUS 完美实现了 [[核心概念/LLM Wiki 基础/LLM Wiki 三层架构]]！
