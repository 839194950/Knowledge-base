...
Marp 是一个基于 Markdown 的幻灯片制作工具和格式，它让你可以用纯 Markdown 语法快速制作美观的演示文稿。Marp 在 [[核心概念/LLM Wiki 基础/LLM Wiki]] 模式中也被提及，作为将 Wiki 内容转化为演示文稿的方法！
...
Marp 和 [[人物与工具/笔记工具/Obsidian]] 完美配合！
