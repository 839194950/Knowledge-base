...
---
标题: 汇编语言 - 文件管理
链接: https://www.runoob.com/assembly/assembly-file.html
内容: 文件管理是程序与外部存储交互的基础。
...
![文件操作流程图](https://www.runoob.com/wp-content/uploads/2026/04/file-io-flow.svg)
...
| O_WRONLY | 1           | 只写        |
| O_RDWR   | 2           | 读写        |
| O_CREAT  | 64（0x40）    | 若文件不存在则创建 |
| O_TRUNC  | 512（0x200）  | 打开时清空文件内容 |
| O_APPEND | 1024（0x400） | 追加到文件末尾   |
