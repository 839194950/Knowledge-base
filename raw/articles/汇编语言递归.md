...
---
标题: 汇编语言 - 递归
链接: https://www.runoob.com/assembly/assembly-recursion.html
内容: 递归（Recursion）是函数调用自身的技术。在汇编中实现递归需要正确管理栈帧，每次调用都有独立的参数和局部变量副本。
...
![递归调用栈 - factorial(5)](https://www.runoob.com/wp-content/uploads/2026/04/recursion-callstack.svg)
